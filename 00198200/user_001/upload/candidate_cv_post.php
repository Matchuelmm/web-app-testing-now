<?php
	...
	$related_company = $_POST['company_key'];
	$current_date = date('Y-m-d H:i:s');
	$cv_uploaded_one = $_POST['cv_data'];
	$cv_uploaded_two = $_POST['cv_data_two'];
	$cv_uploaded_three = $_POST['cv_data_three'];
	$cv_uploaded_four = $_POST['cv_data_four'];
	$cv_uploaded_five = $_POST['cv_data_five'];
	$cv_uploaded_six = $_POST['cv_data_six'];
	

	$sql = "INSERT INTO candidate_cv (id,candidate_name,candidate_surname,company_related,date_time,cv_copy_one,cv_copy_two,cv_copy_three,cv_copy_four,cv_copy_five,cv_copy_six) VALUES ('0', 
		'".$candidate_name."',
		'".$candidate_surname."',
		'".$related_company."',
		'".$current_date."',
                            ...
                            <!-- Content Column -->                        
	                            <br></br>
									...
									<span class='glyphicon glyphicon-ok' ><img src='img/confirm.png' style='width: 60%; height: 60px;'></span>
											...
											<h1>Success!</h1>
											<p>The candidate Cv has Been Uploaded Successfully!</p>
										</div>
