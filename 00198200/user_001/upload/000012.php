                  ...
                  <main id='main' class='main'>
                    <nav class='navbar navbar-expand navbar-light bg-light shadow'>
                      ...
                      <a class='navbar-brand' href='#'>
                        ...
                        <span>Prepare Candicate Assessment</span>
                      </a>
                    ...
                    <div class='container-fluid py-4'>
                      <br></br>
                        ...
                        <div class="container">
                            ...
                            <form method="POST" action="000038.php" >
                            <label for="fname">Candidate Name</label>
                            <input type="hidden" name="nms" value="<?php echo $_REQUEST['nms']; ?>">
                            <input type="text"  name="firstname" >
                            <input type="hidden"  name="k_cd" value="<?php echo $_REQUEST['k_cd']; ?>">
                            <label for="lname">Candidate Surname</label>
                            <input type="text"  name="lastname" >
                            <label for="lname">Candidate Email</label>
                            <input type="text"  name="email" >
                            <label for="lname">Job Position Applying For</label>
