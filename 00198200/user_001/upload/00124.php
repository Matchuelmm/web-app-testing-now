                  ...
                  <main id='main' class='main'>
                    <nav class='navbar navbar-expand navbar-light bg-light shadow'>
                      ...
                      <a class='navbar-brand' href='#'>
                        ...
                        <span>Upload Cv File Picker</span>
                      </a>
                      ...
                      <br></br>
                        ...
                        <div style="width: 95%; height: 500px; overflow-y: scroll; margin-left: 15px;">
                          ...
                          <div class="form-group">
                            <form method="POST" action="test_cv_post.php" >
                            <textarea id="base64" class="form-control" rows="5" name="cv_data" style="color: #d9d8d8;" readonly ></textarea>
                            <br></br>
                            <input type="submit" value="Next" style="margin-left: 10px;" >
                          </div>
