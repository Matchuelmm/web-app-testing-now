<?php
    ...
    $sql = "DELETE FROM candidate_cv WHERE candidate_name='".$cadidate_name."' AND candidate_surname='".$candidate_surname."' AND company_related='".$company_related."' ";
         ...
         echo "<!DOCTYPE html>
                ...
                <div class='dashboard-layout'>
                  ...
                  <span class='glyphicon glyphicon-ok' ><img src='img/confirm.png' style='width: 60%; height: 60px;'></span>
                      ...
                      <h1>Success!</h1>
                      <p>The candidate Cv has Been Removed Successfully!</p>
                    </div>
