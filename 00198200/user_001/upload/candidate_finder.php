                          ...
                          <table>
                            ...
                            <tbody>
                              ...
                              <?php
                                    ...
                                    $sql = "SELECT id, candidate_name, candidate_surname, cv_copy_one,cv_copy_two,cv_copy_three,cv_copy_four FROM candidate_cv WHERE candidate_name='".$_POST['firstname']."' AND candidate_surname='".$_POST['lastname']."' AND company_related LIKE '".$_POST['k_cd']."%".    "' ";
                                    ...
                                    if ($result->num_rows > 0) {
                                      ...
                                      while($row = $result->fetch_assoc()) {
                                        echo  "<tr><td data-label='Account'><img src='img/loggedin.png' style='width:20px; height:20px;'></img>".$row['candidate_name']."</td>
                                               ...
                                               <td data-label='Account'><img src='img/cvdoc.png' style='width:20px; height:20px; margin-right:10px;'></img><input type='button' value='View Cv' onclick='viewDocument()'>&nbsp;&nbsp;&nbsp;<input type='button' value='Go Back' onclick='history.back()'><textarea id='base64' class='form-control' rows='1' name='cv_data' style='width:60%;' hidden>".$row['cv_copy_one'].$row['cv_copy_two'].$row['cv_copy_three'].$row['cv_copy_four']."</textarea></td></tr>";
                                      }
                                    } else {
                                      echo "0 results";
                                    }
